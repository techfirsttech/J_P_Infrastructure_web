...
class LoginApiController extends Controller
{
    ...
    public function index(Request $request)
   {
        ...
        $user = User::select('id', 'name', 'mobile', 'username', 'email', 'password', 'location_tracking')
        ...
        $updateMobileInformation = [
            ...
            'device_info' => ($request->device_info) ? $request->device_info : null,
        ];
        User::where('id', $user->id)->update($updateMobileInformation);
