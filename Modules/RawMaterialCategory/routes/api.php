...
use Modules\RawMaterialCategory\Http\Controllers\RawMaterialCategoryApiController;
...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    Route::post('raw-material-category-add', [RawMaterialCategoryApiController::class, 'store']);
