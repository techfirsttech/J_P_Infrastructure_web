...
return new class() extends Migration {
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('roles')) {
            ...
            // If the roles table already exists, we need to ensure it has the correct columns
            if (!Schema::hasColumn($tableNames['roles'], $columnNames['team_foreign_key']) && ($teams || config('permission.testing'))) {
