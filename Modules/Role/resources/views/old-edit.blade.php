            ...
            <div class="card-header">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="name" value="{{ old('name', $role->name ?? '') }}" placeholder="{{ __('role::message.name') }}" class="form-control">
                    </div>
                    <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div class="form-check mb-0 me-4 me-lg-12">
                                                <input class="form-check-input s-child child-checkbox child_{{ $permissionGroup['name'] }}" {{ in_array($child->id, $rolePermissions) ? 'checked' : '' }}
