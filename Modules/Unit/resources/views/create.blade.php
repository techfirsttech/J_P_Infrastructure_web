...
<div class="row">
    <div class="col-12 mb-2">
        <h5 class="content-header-title float-start mb-0">{{ __('unit::message.add') }}</h5>
        @can('unit-list')
                ...
                <form id="form" action="javascript:void(0);" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-8 form-group custom-input-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="{{ __('unit::message.name') }}">
                                ...
                                <tbody class="sub_data inner-clone">
                                    <tr class="design_tr">
                                        ...
                                        <td class="custom-input-group text-center">
                                            <button type="button" class="btn btn-sm text-danger border-0 remove-design">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-1">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary float-end save" id="saveButton" data-route="{{ route('unit.store') }}">{{ __('message.common.submit') }}</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script type="application/javascript">
    ...
    $(document).on("click", ".add-design", function() {
        ...
        $('.child-unit-select').trigger('change');
