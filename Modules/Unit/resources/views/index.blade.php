...
<div class="row">
     <div class="col-12 mb-2">
          <h5 class="content-header-title float-start mb-0">{{ __('unit::message.list') }}</h5>
          @can('unit-create')
          <a href="{{route('unit.create')}}" class="btn btn-sm me-1 btn-primary new-create float-end"><i class="fa fa-plus me-25"></i> {{ __('message.common.addNew') }}</a>
          @endcan
     </div>
     <div class="col-12">
          <div class="card p-1">
